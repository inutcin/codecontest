...
задач 
2. Добавление новых полей в форму договора на обучение
3. Добавление новых полей в форму договора на преподавание
4. Добавление новых способов аутентификации, в том числе через ЕСИА
5. Изменение оформления формы сертификата
...
| N |   3.2.1  | 3.2.2 | 3.2.3 | 3.2.4 | 3.2.5 | 3.2.6 | 3.2.7 | 3.2.8 | 3.2.9 |
|---|----------|-------|-------|-------|-------|-------|-------|-------|-------|
| 1 |          |       |       |       |       |       |       |       |       |
| 2 |          |       |       |       |       |       |       |       |       |
| 3 |          |       |       |       |       |       |       |       |       |
