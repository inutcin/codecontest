...
3) Отказы приниятия решений. Количество отказов при приёме задач на проверку не 
...
Оставиться архитектуру неизменной, доработав регламенты обмена сообщениями и
документами для оптимизаци производительности труда.
